...
remain weak ($0.55$--$0.63$ ROC-AUC) at both 1.5B and 3B scale. The same
pattern holds in a same-source GSM8K control: Gemma-4 labels on the same 400
GSM8K ProcessBench candidate solutions reach only $0.549$ ROC-AUC with
privileged labels and $0.618$ without ground-truth access, below the $0.751$
GSM8K gold mean. The evidence
...
confound for one source split and remains negative, but it still should not be
read as isolating human-curated versus generated provenance: generated labels
also differ in label semantics, calibration, and prompt/rendering format.
