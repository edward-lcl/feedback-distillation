...
A stronger post-hoc score average combines the three GSM8K 1500-step seeds with
the four OmniMath 500-step seeds. This seven-member average reaches 0.8276
ROC-AUC, 0.3433 PR-AUC, and best eval-swept F1 0.4050. It beats the best
generated-label baseline by +0.1953 ROC-AUC (95% CI [0.1742, 0.2161],
p=0.0004). Qwen PRM800K is higher by +0.0101 ROC-AUC, but this gap is not
significant under sequence-cluster bootstrap (95% CI [-0.0082, 0.0276],
p=0.2675). On the held-out threshold split, the seven-member average has
higher eval PR-AUC than Qwen (0.3413 vs 0.3242), but lower calibrated F1
(0.3754 vs 0.3855). This is the strongest appendix diagnostic so far and
should not be framed as a state-of-the-art PRM claim. The subsequently
completed 1500-step follow-up grid was high variance rather than a clean
replacement: GSM8K seed 3 was healthy but modest, and OmniMath seeds 2-3
